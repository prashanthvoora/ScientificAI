...
class HighKALIGNN(nn.Module):
    ...
    def configure_structural_adapter(self, enabled: bool = True, rank: int = 16):
        """Configure a zero-initialized low-rank correction on frozen crystal embeddings."""
        rank = int(rank)
        ...
        log.info("v4.56 STRUCTURAL-ADAPTER: enabled=%s rank=%d zero_init=True", enabled, rank)
