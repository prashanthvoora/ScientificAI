...
TIER3_TRAIN_CONFIG = dict(
    epochs         = 0,      # v4.31: baseline/calibration-only; residual training disabled until it helps
    ...
    learning_rate  = 5e-6,   # v4.29: safer LR for residual-only Tier3 fitting
    weight_decay   = 1e-4,
    scheduler      = "cosine",
    loss           = "mse",
    max_grad_norm  = 1.0,
    ...
    process_delta_bound      = 0.0,   # v4.31: learned residual disabled; deterministic family offset remains active
    process_delta_use_categorical = True,
    ...
    enable_material_family_offset = True,
...
class HighKALIGNN(nn.Module):
    ...
    def _process_bounded_delta(self, proc_context: Optional[dict]) -> Optional[torch.Tensor]:
        ...
        if not bool(avail.any()):
            ...
            return family_offset + learned_zero
        ...
        # learned residual. With process_delta_bound=0 this becomes a stable,
        # interpretable calibrated frozen-baseline predictor.
        return family_offset + learned_delta
