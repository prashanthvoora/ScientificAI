...
def main():
    ...
    for split in ('test','val'):
        r,s=compare(find_pred(na,split),find_pred(nb,split),a.label_a,a.label_b,split,a.process_delta_bound);r.to_csv(out/f'tier3_checkpoint_transfer_row_comparison_{split}.csv',index=False);allr.append(r);alls.append(s);maps[split]=r.attrs['mapping']
