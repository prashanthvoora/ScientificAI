...
==============================================================================
 ...
 Version 4.5.6  (Tier 3 training quality: log-space target, experimental
                upweighting, hyperparameter tuning)
==============================================================================
 v4.5.6 fixes  (Tier 3 test results still ≈ Tier 2 despite correct data flow)
 ---------------------------------------------------------------------------
