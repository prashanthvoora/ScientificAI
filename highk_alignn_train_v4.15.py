...
==============================================================================
 ...
 Version 4.5.12 (v4.15: fix RuntimeError loading state_dict for HighKALIGNN)
==============================================================================
...
def _remap_state_dict(state: dict) -> dict:
    """
    Translate legacy checkpoint key names to current names before load_state_dict.

    CKPT-RT3: Handles the v4.5.3→v4.5.11 rename:
      task_heads.k_measured.*     → task_heads.k_total.*
      task_heads.k_measured_log.* → task_heads.k_total_log.*

    Without this, strict=False silently skips the old keys (unexpected) and
    random-initialises the new keys (missing), discarding all learned k weights.
    With this, the k weights transfer correctly even across the rename.
    """
    KEY_REMAP = {
        "task_heads.k_measured_log.": "task_heads.k_total_log.",
        "task_heads.k_measured.":     "task_heads.k_total.",
