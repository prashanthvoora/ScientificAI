...
class ALIGNNTrainer:
    ...
    def capture_frozen_base_reference(self):
        ...
        # v4.59.4: derive the exclusion set from requires_grad rather than
        ...
        if overlap:
            raise RuntimeError(
                "v4.59.4 FROZEN-SNAPSHOT INVALID: trainable parameters were "
                f"captured as frozen: {overlap[:10]}"
            )
        log.info(
            "v4.59.4 BASE-SNAPSHOT: captured %d frozen parameters/buffers; "
