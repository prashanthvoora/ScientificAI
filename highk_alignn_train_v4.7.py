...
==============================================================================
 ...
 Version 4.5.4  (Tier 3 readiness fixes -- process column rename, tier3_evaluate,
                J_g task weight correction, targeted Tier 3 rebuild flag,
                experimental row_hash collision fix, early-stopping config,
                Option-A structure imputation for process-only rows)
==============================================================================
...
class DatasetExtractor:
    ...
    def load_experimental_process_db(
        ...
        # Align process_db.csv target column names to the unified pipeline schema.
        target_renames = {
            "k_measured":   "k_measured",
