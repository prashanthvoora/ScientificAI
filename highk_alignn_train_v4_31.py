...
def run_tier3_finetune(
    ...
    if freeze_backbone:
        ...
        # Previously: b2_epochs = cfg["epochs"] - best_epoch.
        # With best_epoch=1 (val noise), this gave b2_epochs=149 — wrong.
        # Phase B2 purpose is gentle joint fine-tuning after proc_encoder warmup;
        # it needs a fixed, meaningful budget independent of Phase B val noise.
        ...
        # update cfg for B2
        # APPROACH-1 Phase B2: raise exp_sample_weight to 1.0 (equal weighting).
        # proc_encoder has now had Phase B to warm up from random init; equal
        # weight lets it refine its correction on top of the stabilised backbone
        # without being artificially amplified while still noisy.
        # v4.31: exp_sample_weight=1.0 in Phase B2 (equal DFT/exp weighting).
        # proc_encoder is still frozen so experimental rows contribute only
        # through the task_head and context_proj paths (no encoder gradient).
        ...
        trainer.cfg = {
            **cfg,
            ...
            "early_stopping":    False,   # val set too small; run full b2_epochs
        }
