...
==============================================================================
 ...
 Version 4.5.20 (v4.23: expand donor pool to all high-k families + HfO2 fallback)
==============================================================================
    ...
    def build_tier3(
        ...
        def is_hfo2_family(formula):
            if not isinstance(formula, str):
                return False
            # Include all high-k oxide families: Hf, Zr, Al, Ti, Ta, Sr, La, Y
            # and their ternary/multilayer variants present in the CSV.
            has_o = "O" in formula
