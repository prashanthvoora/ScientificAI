...
TIER3_TRAIN_CONFIG = dict(
    epochs         = 80,     # v4.38: enable frozen-backbone process-residual training
    ...
    process_delta_bound      = 0.10,  # v4.38: bounded ±0.10 log(k) learned correction
    process_delta_use_categorical = False,  # start with numerical process features only
