...
def run_tier3_finetune(
    ...
    if freeze_backbone:
        ...
        trainer.cfg = {**cfg, "exp_sample_weight": _pb_exp_w}
        log.info(
            "Phase B exp_sample_weight = %.2f  (DFT-dominant; proc_encoder warming up)",
            _pb_exp_w,
        )
        ...
        log.info(
            "Phase B2 exp_sample_weight = %.2f  (equal weighting; proc_encoder stabilised)",
            _pb2_exp_w,
        )
        _saved_cfg = trainer.cfg
        trainer.cfg = {
