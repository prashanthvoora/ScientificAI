...
==============================================================================
 ...
 Version 4.5.23 (v4.26: fix tier3_evaluate — imputation + reset_index + correct metrics)
==============================================================================
 v4.5.23 fixes  (v4.26: tier3_evaluate N_Valid=9 root cause and fixes)
 ---------------------------------------------------------------------------
...
def run_tier_evaluate(
    ...
    if tier == 1:
        ...
        if n_proc_only > 0 and df_tier2 is not None:
            HIGH_K_ELEMS_DONOR = {"Hf", "Zr", "Al", "Ti", "Ta", "Sr", "La", "Y",
                                  "Ba", "Nb", "Ga", "In", "Sc", "Ce", "Pr", "Nd"}
            ...
            log.info("Tier 3 evaluate: running imputation on %d process-only rows...", n_proc_only)
            ...
            if len(df_imputed) > 0:
                ...
                log.info("Tier 3 evaluate: df_structural after imputation=%d rows", len(df_structural))
        elif n_proc_only > 0:
            log.warning(
                "Tier 3 evaluate: %d process-only rows cannot be imputed "
                "(df_tier2 not available). N_Valid will be lower than during training.",
                n_proc_only,
            )
